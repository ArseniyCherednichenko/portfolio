...
export const NOW_ITEMS: readonly NowItem[] = [
  ...
  },
  {
    ...
    body: 'This site is my open workbench for interface animation, now past two hundred hand-built components — pinned scroll, magnetic controls, cursor fields, self-drawing line art. A new one most days. If it lands here, I understand it.',
    detail: [
