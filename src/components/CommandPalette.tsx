...
function Palette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const commands = useMemo<Command[]>(() => {
    const pages: Command[] = [
      ...
      { id: 'start', label: 'Start here', group: 'Pages', hint: 'where to begin', keywords: 'start here begin guide orientation new first time where to go paths hiring craft quick wander welcome introduction', run: () => go('/start') },
      ...
      { id: 'bio', label: 'Bio', group: 'Pages', hint: 'the short version, copyable', keywords: 'bio biography about short version press kit introduce introduction copy paste blurb byline speaker fast facts who is arseniy', run: () => go('/bio') },
